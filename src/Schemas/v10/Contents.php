	...
	*/
	public function dataHook($rows = null)
	{
		...
		foreach ($rows as $row)
		{
			...
			if (version_compare(UpgradeHelper::getVersion($this->container, 'external_version'), '2.5', '<')
				&& version_compare(UpgradeHelper::getVersion($this->container, 'origin_version'), '3.1', '>=')) {
