 ...
 * @since  11.1
 */
class TableMenuType extends Table
{
	/**
	 * Constructor
	 *
	...
	public function check()
	{
		...
		$this->menutype = OutputFilter::stringURLSafe($this->menutype);
	...
	public function store($updateNulls = false)
	{
		if ($this->id)
		{
			...
			$table = Table::getInstance('Menutype', 'Table', array('dbo' => $this->getDbo()));
			$table->load($this->id);
	...
	{
		$assetId = null;
		$asset = Table::getInstance('Asset', 'Table');
